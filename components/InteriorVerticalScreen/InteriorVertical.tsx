...
import { styles } from './Vertical'
type DetailsRoutesProps = RouteProp<RootStackParamList, 'InteriorsVertical'>


export default function InteriorsVertical() {
            ...
            <View style={styles.content}>
                ...
                <GestureDetector gesture={pinch}>
                    <View style={styles.containerImg}>
                        <Animated.Image source={item} style={[styles.img, animatedStyles]} />
                    </View>
                </GestureDetector>
