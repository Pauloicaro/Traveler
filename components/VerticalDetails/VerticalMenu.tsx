import {
    ...
    Image, TouchableOpacity, StatusBar, Modal, ImageSourcePropType,
    SafeAreaView
} from 'react-native';
    ...
    const InteriorImageVertical = ({ item, index }: { item: ImageSourcePropType, index: number }) => {
        return <View>
            <Animation.View style={styles.interiosContainer} exiting={FadeInDown.delay(index * 100)}>
                <TouchableOpacity onPress={() => Navigation.navigate('InteriorsVertical', { item: item, index: index })}>
                    ...
                    <View style={styles.ContainerReservar}>
                        ...
                        <View>
                            <TouchableOpacity style={styles.ContainerReserver}
                                activeOpacity={0.5}
                                onPress={() => Navigation.navigate('ReserveVertical', { item: item })}>
